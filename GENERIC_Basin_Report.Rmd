...
knitr::kable(wqlim4.df, padding = 2, caption = tbls(name="tbl.wql", caption="Number of impaired stream segments with and without a TMDL as identified in Oregon's 2012 Integrated Report and Assessment database"))
...
if(NROW(tmdls.df) > 0){
  print(knitr::kable(tmdls.df2, padding = 2, caption = tbls(name="tbl.tmdls", caption=paste0("Approved TMDLs in the ",owrd_basin," Basin and the impairments addressed by those TMDLs."))))
}
