---
title: "Appendix G"
subtitle: "Willamette Basin Report"
author: "Ryan Michie"
date: "April 18th, 2018"
output:
  word_document:
    reference_docx: \\deqhq1\WQNPS\NPS_Annual_Reports\2017\Basin_Reports_2017\word_template_style_DEQ.docx
    toc: false
    fig_caption: true
  html_document:
...
appendix_prefix <- list("Deschutes"="A",
...
# Set the correct Appendix letter prefix
a.prefix <- appendix_prefix[[owrd_basin]]
...
tbls  <- captioner(prefix=paste0("Table ",a.prefix,"-"), auto_space = FALSE)
figs <- captioner(prefix=paste0("Figure ",a.prefix,"-"), auto_space = FALSE)
...
if(projects.n > 0){
  print(knitr::kable(projects.df, padding = 2, digits = 1, row.names=FALSE, format="markdown", 
